...
public abstract class NearbyListAdapter extends RecyclerView.Adapter {
    ...
    private String TAG = NearbyListAdapter.class.getName();
    private NearbyCallback nearbyCallback;
    private boolean isMapView = false;

    public NearbyListAdapter(Context context, ArrayList<Object> dataArray) {
    ...
    public NearbyListAdapter(Context context, ArrayList<Object> dataArray, NearbyCallback nearbyCallback) {
        this.context = context;
        this.dataArray = dataArray;
    ...
    public NearbyListAdapter(Context context, ArrayList<Object> dataArray, NearbyCallback nearbyCallback, boolean isMapView) {
        this.context = context;
        this.dataArray = dataArray;
        this.nearbyCallback = nearbyCallback;
