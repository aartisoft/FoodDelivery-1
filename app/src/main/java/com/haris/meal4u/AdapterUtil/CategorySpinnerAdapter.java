...
public class CategorySpinnerAdapter extends BaseAdapter {
    ...
    public CategorySpinnerAdapter(Context context, ArrayList<ViewTypeObject> objects) {
        this.context = context;
        this.objects = objects;
        this.layoutInflater = LayoutInflater.from(context);
    }

    public CategorySpinnerAdapter(Context context, ArrayList<ViewTypeObject> objects,boolean isLightBackground) {
        this.context = context;
        this.objects = objects;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            if (isLightBackground){
                ...
                layout=R.layout.spinner_objective_item_layout;
            }
