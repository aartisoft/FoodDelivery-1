...
public class SingleDateAndTimePicker extends LinearLayout {
    ...
    public SingleDateAndTimePicker setFontId(int fontId) {
        this.fontId = fontId;

        for (WheelPicker picker : pickers) {
            picker.setFontId(fontId);
        }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setFontId(a.getResourceId(R.styleable.SingleDateAndTimePicker_picker_typeface, 0));
