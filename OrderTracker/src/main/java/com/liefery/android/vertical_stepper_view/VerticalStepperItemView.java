...
public class VerticalStepperItemView extends FrameLayout {
    ...
    private void initialize( Context context ) {
        ...
        title.setTypeface(ResourcesCompat.getFont(getContext(), R.font.ubunt_regular));

        image = (ImageView) findViewById( R.id.vertical_stepper_view_item_image );

        summary = (TextView) findViewById( R.id.vertical_stepper_view_item_summary );
        summary.setTypeface(ResourcesCompat.getFont(getContext(),R.font.ubuntu_light));
    ...
    public VerticalStepperItemView setImage(int imageResourceId) {
